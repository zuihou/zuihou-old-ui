  ...
  <div class="search-condition">
    ...
    >
      <el-form-item label="操作IP">
        <el-input
          placeholder="操作IP"
          v-model="searchCondition.requestIp"
        ></el-input>
      </el-form-item>
      ...
      <el-form-item label="日志类型">
        ...
        >
          <el-option
            ...
            :label="val"
            :value="key"
            v-for="(val, key) in enums.LogType"
          ></el-option>
        </el-select>
      </el-form-item>
      ...
      <el-form-item label="请求地址">
        <el-input
          placeholder="请求地址"
          v-model="searchCondition.requestUri"
        ></el-input>
      </el-form-item>
      <el-form-item label="请求类型">
        <el-select
          placeholder="请求类型"
          v-model="searchCondition.httpMethod"
        >
          <el-option
            :key="key"
            :label="val"
            :value="key"
            v-for="(val, key) in enums.HttpMethod"
          ></el-option>
        </el-select>
      </el-form-item>
      <el-form-item label="类路径">
        <el-input
          placeholder="类路径"
          v-model="searchCondition.classPath"
        ></el-input>
      </el-form-item>
      <el-form-item>
        <el-button
